...
<div class="header-wrapper fixed top-0 left-0 w-full z-60 transition-opacity duration-500">
  ...
  <!-- ナビゲーション（最前面） -->
  <nav class="navigation fixed top-0 right-0 z-70 translate-x-full font-['myfont',serif] w-[320px] bg-white shadow-[-4px_0_8px_rgba(0,0,0,0.2)] pt-8.5 transition-transform ease-in-out duration-300">
    <button class="navi-close absolute right-3 w-5 h-5 cursor-pointer
    ...
    <ul class="flex flex-col items-center pt-12 pl-8 pb-50 gap-5 text-sm">
